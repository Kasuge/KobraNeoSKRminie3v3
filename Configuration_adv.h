...
// @section bltouch
   ...
   */
  #define BLTOUCH_SET_5V_MODE// раскоментил от ошибки
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_CONNECTION ONBOARD// тут был онбоард
 ...
 */
#define G29_RETRY_AND_RECOVER// тут раскоментил
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       800        // тут поменял (mA) RMS current. Multiply by 1.414 for peak current.
    ...
    #define Y_CURRENT       800// тут поменял было 580
    ...
    #define Z_CURRENT       800// тут поменял было 580
    ...
    #define E0_CURRENT      600// тут было 650
...
#define M115_GEOMETRY_REPORT // раскоментил
#endif
